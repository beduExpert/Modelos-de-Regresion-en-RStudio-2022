# Predicción de salarios usando años de experiencia
...
# los valores de x (Años de experiencia)
...
# contra los valores de x (Años de experiencia)
...
# Finalmente obtenemos la predicción para el salario cuando
# los años de experiencia son 10, así como el intervalo
