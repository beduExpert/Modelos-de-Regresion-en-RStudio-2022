...
1. Ajuste modelos de regresión lineal múltiple a los datos [`advertisement.csv`](https://raw.githubusercontent.com/beduExpert/Modelos-de-Regresion-en-RStudio-2022/main/Sesion-02/Reto-01/advertising.csv) y elija el modelo "más adecuado" siguiendo los procedimientos vistos en el Ejemplo 1.
